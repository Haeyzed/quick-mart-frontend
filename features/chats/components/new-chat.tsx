...
import { Check, MultiplicationSignIcon } from '@hugeicons/core-free-icons'
          ...
          <div className='flex flex-wrap items-baseline-last gap-2'>
            ...
            {selectedUsers.map((user) => (
              <Badge key={user.id} variant='default'>
                ...
                >
                  <HugeiconsIcon icon={MultiplicationSignIcon} className='h-3 w-3 text-muted-foreground hover:text-foreground' />
                </button>
              </Badge>
            ))}
          </div>
