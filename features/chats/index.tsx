...
// Fake Data
import conversationsData from './data/convo.json'
            ...
            <div className='sticky top-0 z-10 -mx-4 bg-background px-4 pb-3 shadow-md sm:static sm:z-auto sm:mx-0 sm:p-0 sm:shadow-none'>
              <div className='flex items-center justify-between py-2'>
                <div className='flex gap-2'>
                  ...
                  <HugeiconsIcon icon={Message} size={20} />
                </div>
                ...
                >
                  <HugeiconsIcon icon={Edit01Icon} size={24} className='stroke-muted-foreground' />
                </Button>
              </div>
              ...
              >
                <HugeiconsIcon icon={Search01Icon} size={15} className='me-2 stroke-slate-500' />
            ...
            >
              ...
              <div className='mb-1 flex flex-none justify-between bg-card p-4 shadow-lg sm:rounded-t-md'>
                ...
                <div className='flex gap-3'>
                  ...
                  >
                    <HugeiconsIcon icon={ArrowLeftIcon} className='rtl:rotate-180' />
                  </Button>
                ...
                <div className='-me-1 flex items-center gap-1 lg:gap-2'>
                  ...
                  >
                    <HugeiconsIcon icon={Video01Icon} size={22} className='stroke-muted-foreground' />
                  </Button>
                  <Button
                    size='icon'
                    variant='ghost'
                    className='hidden size-8 rounded-full sm:inline-flex lg:size-10'
                  >
                    <HugeiconsIcon icon={Phone} size={22} className='stroke-muted-foreground' />
                  </Button>
                  <Button
                    size='icon'
                    variant='ghost'
                  ...
                  >
                    <HugeiconsIcon icon={MoreVerticalIcon} className='stroke-muted-foreground sm:size-5' />
                  </Button>
                </div>
              </div>
                ...
                <form className='flex w-full flex-none gap-2'>
                  <div className='flex flex-1 items-center gap-2 rounded-md border border-input bg-card px-2 py-1 focus-within:ring-1 focus-within:ring-ring focus-within:outline-hidden lg:gap-4'>
                    <div className='space-x-1'>
                      ...
                      >
                        <HugeiconsIcon icon={PlusSignIcon} size={20} className='stroke-muted-foreground' />
                      </Button>
                      <Button
                        size='icon'
                        type='button'
                    ...
                    >
                      <HugeiconsIcon icon={Send} size={20} />
                    </Button>
                  </div>
                  <Button className='h-full sm:hidden'>
                    <HugeiconsIcon icon={Send} size={18} /> Send
                  </Button>
                </form>
              </div>
            </div>
            ...
            >
              <div className='flex flex-col items-center space-y-6'>
                <div className='flex size-16 items-center justify-center rounded-full border-2 border-border'>
                  <HugeiconsIcon icon={Message} className='size-8' />
                </div>
