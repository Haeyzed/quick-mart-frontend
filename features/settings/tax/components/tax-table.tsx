...
import { useTaxes } from '../api/use-taxes'
import { DataTableBulkActions } from './data-table-bulk-actions'
import { taxesColumns as columns } from './tax-columns'
import { TaxesEmptyState } from './tax-empty-state'
...
export function TaxesTable() {
  ...
  // Fetch data from API
  const { data, isLoading, error } = useTaxes(apiParams)
