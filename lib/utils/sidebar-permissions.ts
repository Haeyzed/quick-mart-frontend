...
const PERMISSION_MAP: Record<string, string | string[]> = {
  ...
  '/products/categories': ['category', 'categories-index', 'products-index'],
  '/products/brands': ['brand', 'brands-index', 'products-index'],
  '/products/units': ['unit', 'units-index', 'products-index'],
  '/products': ['products-index', 'product'],
  '/products/create': ['products-add', 'product'],
  '/products/print-barcode': ['products-index', 'product', 'barcode'],
  '/products/adjustment': ['products-index', 'product', 'adjustment'],
  '/products/adjustment/create': ['products-add', 'product', 'adjustment'],
  '/products/stock-count': ['products-index', 'product', 'stock-count'],
  
  // Purchase
  '/purchases': 'purchase',
  '/purchases/create': 'purchase',
  '/purchases/import-csv': 'purchase',
  
  // Sale
  '/sales': 'sale',
  '/pos': 'pos',
  '/sales/create': 'sale',
  '/sales/import-csv': 'sale',
  '/sales/packing-slips': 'sale',
  '/sales/challans': 'sale',
  '/sales/delivery': 'sale',
  '/sales/gift-cards': 'sale',
  '/sales/coupons': 'sale',
  '/sales/couriers': 'sale',
